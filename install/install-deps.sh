...
sudo apt-get purge -y libreoffice* wolfram-engine
sudo apt-get clean
sudo apt-get update
...
sudo apt-get install -y build-essential cmake pkg-config libjpeg-dev libpng-dev libtiff5-dev libtiff-dev libjasper-dev \
